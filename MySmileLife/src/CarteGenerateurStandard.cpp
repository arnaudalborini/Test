...
void CarteGenerateurStandard::genCartesPioche( vector<IdCarte> &vecCartes)
{
    ...
    for(auto id: mmapMSLCarte[{carteAnimal,csAucun}]){vecCartes.push_back(id);}
    vecCartes.push_back( getFirstSetIdCarte(carteAnimal,csLicorne) );
    for(auto id: mmapMSLCarte[{carteVoyage,csAucun}]){vecCartes.push_back(id);}
...
void CarteGenerateurStandard::addMetier(  ){
    addCarteMSL( new CarteMSL(++cptId,"Architecte",     2,carteMetier, csArchitecte) );
    addCarteMSL( new CarteMSL(++cptId,"Astronaute",     2,carteMetier, csAstronaute) );
    ...
    addCarteMSL( new CarteMSL(++cptId,"ChefDesAchats",  2,carteMetier, csChefDesAchats) );
    addCarteMSL( new CarteMSL(++cptId,"ChefDesVentes",  2,carteMetier, csChefDesVentes) );
    addCarteMSL( new CarteMSL(++cptId,"Chercheur",      2,carteMetier, csChercheur) );
    addCarteMSL( new CarteMSL(++cptId,"Chirurgien",     2,carteMetier, csChirurgien) );
    ...
    addCarteMSL( new CarteMSL(++cptId,"Journaliste",    2,carteMetier, csJournaliste) );
    ...
    addCarteMSL( new CarteMSL(++cptId,"Pharmacien",     2,carteMetier, csPharmacien) );

    addCarteMSL( new CarteMSL(++cptId,"PiloteDeLigne",  2,carteMetier, csPiloteDeLigne) );
    ...
    addCarteMSL( new CarteMSL(++cptId,"Stripteaser",    2,carteMetier, csStripteaser) );
}
void CarteGenerateurStandard::addEtude(   ){
    addCarteMSL( new CarteMSL(++cptId,"Etude Simple", 1,carteEtude, csEtudeSimple) );
    addCarteMSL( new CarteMSL(++cptId,"Etude Double", 1,carteEtude, csEtudeDouble) );
}
...
void CarteGenerateurStandard::addSpecial( ){
    //special 10
    addCarteMSL( new CarteMSL(++cptId,"Anniversaire",  0,carteSpecial, csAnniversaire) );
    ...
    addCarteMSL( new CarteMSL(++cptId,"EtoileFilante", 0,carteSpecial, csEtoileFilante) );
    ...
    // Les distinctions 3
    addCarteMSL( new CarteMSL(++cptId,"LegionHonneur",       3,carteSpecial, csLegionHonneur) );
    addCarteMSL( new CarteMSL(++cptId,"GrandPrixExcellence", 4,carteSpecial, csGrandPrixExcellence) );
}
...
void CarteGenerateurStandard::addFlirt(   ){
    ...
    vector<CarteSousType> vecStr = {csAuParc,csAuBar,csAuTheatre,csAuCinema,csEnBoiteDeNuit,csAuRestaurant,csAuZoo,csSurInternet};
...
void CarteGenerateurStandard::addMalus(   ){
    ...
    addCarteMSL( new CarteMSL(++cptId,"Lit 100 ciments",   0,carteMalus, csLicenciement) );
    addCarteMSL( new CarteMSL(++cptId,"Mâle à dit",        0,carteMalus, csMaladie) );
    addCarteMSL( new CarteMSL(++cptId,"Redoublement",      0,carteMalus, csRedoublement) );
